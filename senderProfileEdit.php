				...
				<div class="col-xs-6">
					<?php
						...
						<form action="" method="POST">
								...
								<div class="input-group">
									<input type="submit" name="submit" class="btn btn-primary" value="Update"><a href="senderProfile.php">&nbsp&nbsp&nbsp<input type="button"  class="btn btn-primary" value="Back to profile"></a>
								</div>
							</form>
